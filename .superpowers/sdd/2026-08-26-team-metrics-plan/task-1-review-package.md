...
Base: working tree before Task 1 (git commits unavailable)
Head: current working tree
Files: src/analysis/types.ts, src/analysis/team-metrics.ts, tests/analysis/team-metrics.test.ts
...
+    minimumHours: Math.min(0, ...hoursByStudent),
